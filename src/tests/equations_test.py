...
class TestEquations(unittest.TestCase):
    ...
    def test_cheer_if_right_result(self):
        self.assertIn(self.equations.cheer_if_right_result(),
                      self.equations.cheers)

    def test_cheer_if_wrong_result(self):
        self.assertIn(self.equations.cheer_if_wrong_result(),
                      self.equations.cheers_if_wrong_answer)
